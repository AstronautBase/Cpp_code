...
private:
    ...
    std::map<char, Instruction *> instruction_map_{
        {'+', new IncrementInstruction()}, {'-', new DecrementInstruction()}, {'>', new MoveRightInstruction()}, {'<', new MoveLeftInstruction()}, {'.', new OutputInstruction()}, {',', new InputInstruction()}, {'[', new LoopBeginInstruction()}, {']', new LoopEndInstruction()}};
